...
import { LogOut, Camera, Edit2, Trash, GitHub, Paperclip } from "react-feather"; 
...
function Account(props) {
    ...
    const[profileImageUrl,setProfileImageUrl]=useState(userDetails.profileImage ||
      "https://tse1.mm.bing.net/th?id=OIP.oSSQTOcjQZvxI-6fa3iMxgHaE8&pid=Api&rs=1&c=1&qlt=95&w=150&h=100");
    ...
    <div className={styles.container}>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.title}>Your Projects</div>
         <button className="button"onClick={()=>setShowProjectForm(true)}>Add Project</button>
        </div>
